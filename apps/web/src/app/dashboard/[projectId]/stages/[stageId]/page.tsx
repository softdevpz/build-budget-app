...
import type { DiaryEntry, Expense, Project, ProjectDocument, Stage } from "@/lib/types";
...
export default async function StagePage({ params }: PageParams) {
  ...
  const [projectRes, stageRes, summaryRes, stagesRes, expensesRes, documentsRes, diaryRes] = await Promise.all([
